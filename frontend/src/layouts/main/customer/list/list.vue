    ...
    <v-card>
      <v-card-title>
        <v-toolbar>
          ...
          <v-spacer></v-spacer>
          <v-btn color="primary" depressed class="mb-2" @click="record()">
            Cadastrar
          </v-btn>
        </v-toolbar>
      ...
      <v-card-text>
        <v-data-table :headers="headers" :items="items" item-key="recnum" :loading="loading" loading-text="Carregando" hide-default-footer>
